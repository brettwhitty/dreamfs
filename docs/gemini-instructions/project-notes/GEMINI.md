...
- We can use the command line tool 'tea' to interact with Gitea
    ...
    - To list all open issues with assignee information: `tea issues --fields index,title,state,author,assignees,milestone,labels,owner,repo`
    - To filter issues by a specific assignee (e.g., 'rd'): `tea issues --assignee rd`
